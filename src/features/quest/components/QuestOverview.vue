...
.quest-overview-header{display:flex;align-items:flex-start;justify-content:space-between;gap:24px}.quest-overview-header h2{font-size:20px;font-weight:900;white-space:nowrap}.quest-overview-tabs{display:grid;min-width:240px;grid-template-columns:1fr 1fr;gap:8px}.quest-overview-tabs button{min-height:42px;padding:0 18px;border:1px solid #e1e1e1;border-radius:999px;background:#fff;color:#666;font-size:14px;font-weight:700}.quest-overview-tabs button.active{border-color:var(--navy);background:var(--navy);color:#fff}
