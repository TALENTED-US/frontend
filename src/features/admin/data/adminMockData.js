...
export const adminFinancePersonaDatasets = [
  {
    ...
    records: [
      ...
      { id: 'rec-2', type: 'transaction', institution: '행복공인중개사', detail: '2026.07.01 · 지출(월세)', amount: -550000, status: 'normal' },
      { id: 'rec-3', type: 'transaction', institution: '한국전력공사', detail: '2026.07.05 · 지출(공과금)', amount: -68000, status: 'normal' },
      { id: 'rec-4', type: 'transaction', institution: '아르바이트 급여', detail: '2026.07.14 · 수입', amount: 450000, status: 'normal' },
    ],
    appliedMembers: [
  ...
  },
  {
    ...
    records: [
      ...
      { id: 'rec-2', type: 'transaction', institution: '고용노동부', detail: '2026.07.01 · 수입(실업급여)', amount: 1200000, status: 'normal' },
      { id: 'rec-3', type: 'transaction', institution: '지하철 정기권', detail: '2026.07.03 · 지출(교통비)', amount: -55000, status: 'normal' },
    ],
    appliedMembers: [
  ...
  },
  {
    ...
    records: [
      ...
      { id: 'rec-2', type: 'transaction', institution: '부모님 용돈', detail: '2026.07.01 · 수입', amount: 300000, status: 'normal' },
      { id: 'rec-3', type: 'transaction', institution: '토익 응시료', detail: '2026.07.08 · 지출(응시료)', amount: -52000, status: 'normal' },
    ],
    appliedMembers: [
  ...
  },
  {
    ...
    records: [
      ...
      { id: 'rec-2', type: 'transaction', institution: 'KTX', detail: '2026.07.02 · 지출(교통비)', amount: -45000, status: 'normal' },
      { id: 'rec-3', type: 'transaction', institution: '게스트하우스', detail: '2026.07.09 · 지출(숙박비)', amount: -38000, status: 'normal' },
    ],
    appliedMembers: [
...
export const adminFinanceDataByUser = {
  jijun01: {
    ...
    history: [
      ...
      { id: 4, target: 'jijun01', item: '주말 카페 아르바이트', action: 'create', summary: '신규 거래 등록 (+300,000원)', actor: '관리자 김재준', at: '2026-07-10T11:47:00+09:00' },
    ],
  },
}
